...
const categories = ref(["Frontend", "Languages", "Tools", "Other"]);
    ...
    <div class="container">
      <div class="section-heading">
        ...
        <p class="text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
          I specialize in frontend development with expertise in modern
      ...
      >
        ...
        >
          <div class="flex items-center mb-4">
            <div
              v-if="skill.icon"
              class="mr-3 text-primary-500 dark:text-primary-400"
            >
              <svg
                class="w-6 h-6"
                viewBox="0 0 24 24"
          ...
          <div
            class="w-full bg-gray-200 dark:bg-gray-600 rounded-full h-3 mb-2"
          >
            <div
