...
<template>
  ...
  >
    <div class="container flex items-center justify-between">
      <!-- Logo -->
      <router-link to="/" class="font-heading text-2xl font-bold text-primary-600 dark:text-primary-400">
        Portfolio
      </router-link>
      ...
      <nav class="hidden md:flex space-x-8">
        <router-link 
          ...
          :class="[
            ...
            isActive(item.path) ? 'text-primary-500' : 'text-gray-800 dark:text-gray-200'
          ]"
        >
          {{ item.label }}
        </router-link>
